...
//		String userPageUrl = loggedPage.substring(loggedPage.indexOf("如果没有自动跳转,请<a href=\"http://t.sina.cn/dpool/ttt/home.php")+19,loggedPage.indexOf("点击这里")-2).replaceAll("&amp;", "&");
