...
/*
<input type="password" name="password_5022" size="30" value=""/><br/> 
<input type="checkbox" name="remember" checked="checked" />记住登录状态，需支持并打开手机的cookie功能。<br/> 
<input type="hidden" name="backURL" value="http://t.sina.cn/dpool/ttt/home.php" /> 
<input type="hidden" name="backTitle" value="新浪微博" /> 
<input type="hidden" name="backURL" value="http://t.sina.cn/dpool/ttt/home.php" /> 
<input type="hidden" name="vk" value="5022_82a3_1812221990" /> 
...
//						System.out.println("tempPage = "+tempPage);
	...
	/*public static void main(String[] args) throws HttpException, IOException
	{
		...
		LoadPage lp = new LoadPage();
		Login lg = new Login();		
		String mainPage = new String(lp.getPageCode("http://t.sina.cn"));
		String loginPageUrl =mainPage.substring(mainPage.indexOf("http://3g.sina.com.cn/prog/wapsite/sso/login.php"),mainPage.indexOf(" id=\"top")-1).replaceAll("&amp;", "&");
